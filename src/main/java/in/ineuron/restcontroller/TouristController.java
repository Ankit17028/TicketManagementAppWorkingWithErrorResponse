...
public class TouristController {
	...
	public ResponseEntity<String> enrollTourist(@RequestBody Tourist tourist){
		...
		return new ResponseEntity<String>(resultMsg, HttpStatus.OK);																									//Error
	}
	...
	@GetMapping("/find/{id}")
	public ResponseEntity<?> diplayTouristById(@PathVariable("id") Integer id){
	...
	public ResponseEntity<String> modifyTourist(@RequestBody Tourist tourist){
		...
		String msg = service.updateToursitByDetailse(tourist);
